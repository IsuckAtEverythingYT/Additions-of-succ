...
public class ZenetiteClumpItem extends SuccsmpModElements.ModElement {
	@ObjectHolder("succsmp:zenetite_clump")
	public static final Item block = null;
	public ZenetiteClumpItem(SuccsmpModElements instance) {
		super(instance, 12);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("zenetite_clump");
		}
