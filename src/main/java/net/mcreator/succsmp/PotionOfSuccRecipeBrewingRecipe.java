...
public class PotionOfSuccRecipeBrewingRecipe extends SuccsmpModElements.ModElement {
	public PotionOfSuccRecipeBrewingRecipe(SuccsmpModElements instance) {
		super(instance, 4);
	}
	...
	public static class CustomBrewingRecipe implements IBrewingRecipe {
		...
		public ItemStack getOutput(ItemStack input, ItemStack ingredient) {
			if (isInput(input) && isIngredient(ingredient)) {
				return PotionUtils.addPotionToItemStack(new ItemStack(input.getItem()), PotionOfSuccPotion.potionType);
			}
